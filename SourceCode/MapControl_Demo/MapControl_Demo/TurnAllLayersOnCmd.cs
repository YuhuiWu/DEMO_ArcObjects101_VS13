...
namespace MapControl_Demo
{
    ...
    /// </summary>
    [Guid("311dbf2f-0cd0-4e99-83db-789015ac9c68")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("MapControl_Demo.TurnAllLayersOnCmd")]
    public sealed class TurnAllLayersOnCmd : BaseCommand
    {
        ...
        public TurnAllLayersOnCmd()
        {
            ...
            base.m_caption = "Turn On All Layers";  //localizable text 
            base.m_message = "Turn On All Layers";  //localizable text
            base.m_toolTip = "Turn On All Layers";  //localizable text
            base.m_name = "TurnAllLayersOnCmd";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
